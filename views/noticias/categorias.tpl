...
<div class="paginador">
<ul class="pagina">
<li {{selected}}><a href="/noticias/categorias/?pag=1&cat={{cate}}&orden={{orden}}&limite={{limite}}"><i class="fa fa-step-backward"></i></a></li>
<li {{selected}}><a href="/noticias/categorias/?pag={{ant}}&cat={{cate}}&orden={{orden}}&limite={{limite}}"><i class="fa fa-angle-double-left"></i></a></li>
<li>{{pag}}</li>
<li {{selected2}}><a href="/noticias/categorias/?pag={{sig}}&cat={{cate}}&orden={{orden}}&limite={{limite}}"><i class="fa fa-angle-double-right"></i></a></li>
<li {{selected2}}><a href="/noticias/categorias/?pag={{total}}&cat={{cate}}&orden={{orden}}&limite={{limite}}"><i class="fa fa-step-forward"></i></a></li>
  </ul>
  </div>
...
<p><i class="fa fa-user"></i> &nbsp;{{it.autor}}</p>
<p>{{it.comentario}}...</p>
